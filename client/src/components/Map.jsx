...
export const Map = (props) => {
    ...
    return(/* width="300px" height="150px" */
        ...
        <h6 className="iframeAdress">URUGUAY 473, TIGRE - BUENOS AIRES - ARGENTINA</h6>
